...
fun PlayerNameSection(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = { if (it.length <= PreferencesViewModel.Companion.PLAYERNAME_MAX_LENGTH) onPlayerNameChange(it) },
            label = { Text(stringResource(R.string.preferences_player_name_label, tempPlayerName.length, PreferencesViewModel.Companion.PLAYERNAME_MAX_LENGTH)) },
            singleLine = true,
            modifier = Modifier.fillMaxWidth()
        )
